...
//            () -> SFMItems.PRINTING_PRESS_ITEM.getTranslationKey() + ".tooltip",
...
//            () -> SFMItems.NETWORK_TOOL_ITEM.getTranslationKey() + ".tooltip.2",
...
//            () -> SFMItems.NETWORK_TOOL_ITEM.getTranslationKey() + ".tooltip.3",
...
//            () -> SFMItems.NETWORK_TOOL_ITEM.getTranslationKey() + ".tooltip.4",
...
//            () -> SFMItems.NETWORK_TOOL_ITEM.getTranslationKey() + ".tooltip.7",
...
//    );
    ...
    public static final LocalizationEntry LABEL_GUN_ITEM_TOOLTIP_3 = new LocalizationEntry(
            () -> SFMItems.LABEL_GUN_ITEM.getTranslationKey() + ".tooltip.3",
