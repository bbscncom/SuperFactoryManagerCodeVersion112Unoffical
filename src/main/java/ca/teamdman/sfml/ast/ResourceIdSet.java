...
public final class ResourceIdSet implements ASTNode {
    ...
    public static final ResourceIdSet MATCH_ALL = new ResourceIdSet(Collections.singletonList(ResourceIdentifier.MATCH_ALL));
    ...
    public ResourceType<?,?,?>[] getReferencedResourceTypes() {
        if (referencedResourceTypes == null) {
            LinkedHashSet<ResourceType> found = new LinkedHashSet<>(SFMResourceTypes.getResourceTypeCount());
