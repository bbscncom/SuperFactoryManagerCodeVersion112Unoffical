...
public class WithDisjunction implements ASTNode, WithClause, ToStringPretty {
    private final WithClause left;
    private final WithClause right;

    public WithDisjunction(WithClause left, WithClause right) {
        this.left = left;
        this.right = right;
    }
    ...
    // Getters
    public WithClause left() { return left; }
    public WithClause right() { return right; }
}
